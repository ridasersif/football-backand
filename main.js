...
function afich_from_player_apdate(){
    selectPosition.addEventListener('change',function(){
        if(selectPosition.value=='GK'){
            document.getElementById("statistiqueJoueur").style.display="none"
            document.getElementById("statistiqueGarde").style.display="block"       
...
fetch('players.json')
 ...
 let cardTest=document.querySelectorAll(".card .nom-jouer h5")
 let testtt= document.querySelectorAll(".card")
 for(i=0;i<testtt.length;i++){
    console.log(cardTest.textContent)
 if(cardTest.textContent!=''){
